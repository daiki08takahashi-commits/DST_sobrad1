...
from app.routers import ai_tools, auth, breathing, chat, companions, family, focus, journal, profile, review, search, settings, stats, study, tasks
...
# Chat "friends" (companions) -- built-in Sõbrad/Friends personas plus any
# custom companion the user adds, and per-companion chat-thread hiding. See
# models.py's Companion docstring and routers/companions.py's module
